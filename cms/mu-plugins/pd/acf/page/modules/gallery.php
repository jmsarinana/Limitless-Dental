...
function fields ( $key ) {
  ...
  $config = array_merge($config, [
    ...
    [
      'key' => "field_gallery_visible_on_desktop_{$key}",
      'name' => "gallery_visible_on_desktop_{$key}",
    ...
    [
      'key' => "field_gallery_visible_on_mobile_{$key}",
      'name' => "gallery_visible_on_mobile_{$key}",
